#include QMK_KEYBOARD_H                                                                                                  b   77 Helpful defines
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * |----------------------------------------------------------------|
    * |Ctrl   |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '| #| Ent|PgDn|
    * |----------------------------------------------------------------|
    ...
    */
    [_BL] = LAYOUT_all(
        ...
        KC_LSPO, KC_NUBS, KC_Z,    KC_X,   KC_C,    KC_V,  KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC,  KC_RSPC, KC_UP,   MO(_FL1),
